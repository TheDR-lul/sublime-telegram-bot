...
Send-TelegramNotification "sublime: deploy started at $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')"
...
Send-TelegramNotification "sublime: deploy finished successfully at $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')"
